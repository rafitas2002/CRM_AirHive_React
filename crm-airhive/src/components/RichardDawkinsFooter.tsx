...
export default function RichardDawkinsFooter() {
    const dawkinsQuotes = useMemo(() => [
        ...
        "The truth is more magical than any myth or made-up mystery or miracle.",
        ...
        "Science is interesting, and if you don't agree, you can fk off.",
        "The beauty of evolution is that it does explain, in a very simple way, the existence of extraordinary complexity.",
        "My eyes are constantly wide open to the extraordinary fact of existence.",
        "The world is divided into things that look as though somebody designed them and things that look as though they didn't.",
