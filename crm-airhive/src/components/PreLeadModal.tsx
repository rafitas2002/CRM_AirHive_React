            ...
            >
                ...
                <div className='p-8 shrink-0 flex items-center justify-between border-b' style={{ background: 'var(--table-header-bg)', borderColor: 'var(--card-border)' }}>
                    <div>
                        ...
                        {mode === 'create' && (
                            <p className='text-xs mt-2 flex items-center gap-2' style={{ color: 'var(--text-secondary)' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                    <polyline points="9 22 9 12 15 12 15 22"></polyline>
                                </svg>
                                <span className='font-semibold'>La empresa se creará automáticamente al guardar</span>
                            </p>
                        )}
                    </div>
                    <button
