                    ...
                    <div className='relative group h-full flex items-center'>
                        <button
                            className={[
                                ...
                                (pathname.includes('/clientes') || pathname.includes('/empresas') || pathname.includes('/suspects') || pathname.includes('/pre-leads') || pathname.includes('/proyectos') || pathname.includes('/cierres')) ? 'active-customer' : ''
                            ].join(' ')}
                        >
                            Customer
                            <span
                                className={[
                                    'absolute left-1/2 -translate-x-1/2 bottom-0 h-[3px] rounded bg-[#2048FF]',
                                    'transition-all duration-300 ease-out',
                                    (pathname.includes('/clientes') || pathname.includes('/empresas') || pathname.includes('/suspects') || pathname.includes('/pre-leads') || pathname.includes('/proyectos') || pathname.includes('/cierres')) ? 'w-full opacity-100' : 'w-0 opacity-0',
                                    'group-hover:w-full group-hover:opacity-100'
                                ].join(' ')}
                            />
                        </button>
                        ...
                        <div className='absolute top-[100%] left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 min-w-[240px] translate-y-2 group-hover:translate-y-0'>
                            <div className='bg-black border border-white/10 rounded-xl overflow-hidden shadow-2xl p-1.5'>
                                {[
                                    { href: '/empresas', label: 'Empresas (Hub)', icon: Building2 },
